tabItem(tabName = "tab_human_input",
        fluidPage(
          ...
          fluidRow(splitLayout(div(DT::dataTableOutput(outputId = "sprinter_deck"), style = "font-size: 80%; width: 50%"),
                    div(DT::dataTableOutput(outputId = "rouler_deck"), style = "font-size: 80%; width: 50%"))),
          fluidRow(div(DT::dataTableOutput("other_decks"), style = "font-size: 70%; width: 90%")),
